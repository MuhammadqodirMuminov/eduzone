export const siteConfig = {
	metaData: {
		title: 'Edu-zone | Dasturlash kurslari',
		description:
	...
	logoText: 'Euu-zone',
	favicon: '/logo.svg',
	copyright: 'Edu-zone. Barcha huquqlar himoyalangan.',
};
